    ...
    return(
        <Container fluid style={{backgroundColor:"#5cdb95",height:"100vh"}} className="d-flex justify-content-center align-content-center ">
            <div className="row d-flex align-items-center justify-content-center">
                 <Form style={{backgroundColor:"#379683"}} onSubmit={(e)=>{handleSubmit(e,email,Password,rememberMe,handleClose,handleOpen,history)}} className="col-11 col-sm-8 col-md-8 col-lg-8 col-xl-8 p-4 p-lg-5 p-md-5 p-sm-5 p-xl-5 p-xxl-5 rounded-2">
                    <div className="row">
