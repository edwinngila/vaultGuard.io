    ...
    return(
        <Container fluid style={{backgroundColor:"#5cdb95",height:"100vh"}} className="d-flex justify-content-center align-content-center ">
            <div className="row d-flex align-items-center justify-content-center">
                <Form onSubmit={(e)=>{handleSubmit(e,FirstName, SecondName, email, Password,handleClose,handleOpen,history)}} className="col-11 col-sm-10 col-md-10 col-lg-9 col-xl-9 col-xxl-9 p-4 p-lg-5 p-md-5 p-sm-5 p-xl-5 p-xxl-5 rounded-2" style={{backgroundColor:"#379683"}}>
                    <div className="row">
